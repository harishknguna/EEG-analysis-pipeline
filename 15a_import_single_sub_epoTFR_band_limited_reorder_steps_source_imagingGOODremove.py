...
freq_band_name = 'beta_low' # 'theta'or 'beta_low' # CHANGE HERE
condi_name = ['NoGo'] # CHANGE HERE
...
for ei, evnt in enumerate(event_type):
    ...
    for ci, condi in enumerate(condi_name): 
        ...
        def run_tfr_source_imaging(subject):
            ...
            extension =  condi_name[ci] +'_' + event_type[ei] +'_' + version + '_' + waveType +'_'+ freq_band_name +'_' + 'PWR_CMPLX-tfr.h5'
...
#%%                                    
        ...
        parallel(run_func(subject) for subject in config_for_gogait.subjects_list)
