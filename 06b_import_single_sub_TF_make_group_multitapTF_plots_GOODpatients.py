...
=============================================
06b. For patients: import single sub multitaper TF, and plot group average power 
==============================================
Imports the MNE single sub TF (baseline uncorrected) object obtained in script 05 and 
        ...
        for ci, condi in enumerate(condi_name): 
            ...
            for sub_num, subject in enumerate(config_for_gogait.subjects_list_patients): 
                ...
                if baseline == 'bslnCorr':
                    ...
                    extension =  condi_name[ci] +'_' + event_type[ei] +'_' + dbs +'_' +  version + '_' + waveType +'_PWR_bslnCorr-tfr.h5'
                elif baseline == 'bslnNoCorr':
                    print('Importing the TFR_power from disk')
                    extension =  condi_name[ci] +'_' + event_type[ei] +'_' + dbs +'_' +  version + '_' + waveType +'_PWR-tfr.h5'
            ...
            report.add_figure(fig, title = condi + '_TF_multiTap', replace = True)
