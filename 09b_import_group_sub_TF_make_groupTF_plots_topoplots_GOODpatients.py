...
"""
=============================================
09b. for patients: import group (grand averaged across subjects) complex abs TF,  
    ...
    for veri, version in enumerate(version_list):
        for di, dbs in enumerate(DBSinfo): 
            ...
            for ci, condi in enumerate(condi_name): 
                ...
                subject ='ABSTA46'
                print("\nProcessing sample subject: %s" % subject)
                ...
                print('\n Importing the grand averaged complex epochsTFR from disk')
            ...
            ## patients and HC have same time points
            ...
            report.title = 'Group patients TFRs and topomaps : ' + evnt +'_' + dbs +'_' + version + '_' + waveType +'_'+ numType +'_'+ baseline+ '_abs(.)' 
            #report.title = 'Group sub STC contrast at ' + evnt
            extension = 'group_patients_TF_maps_and_topomaps'
            report_fname = op.join(config_for_gogait.report_dir, config_for_gogait.base_fname_generic.format(**locals()))
            report.save(report_fname+'_' + evnt +'_' + dbs +'_' + version + '_' + waveType +'_'+ numType +'_'+ baseline +'_abs.html', overwrite=True)            
