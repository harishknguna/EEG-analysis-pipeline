...
"""
=============================================
11a. Imports single sub STC files and make group STC (average and SD across subjects)
==============================================
...
for ei, evnt in enumerate(event_type):
    ...
    #     extension = condi_name[ci] +'_' + event_type[ei] + '_hc_' +'stcGSTD' +'_evoked_' + version +'_' + method +'_' + ampliNormalization +'_' + bsln
    #     stc_fname_array = op.join( config_for_gogait.eeg_dir_GOODremove,
    #                           config_for_gogait.base_fname_avg_npy.format(**locals()))
    #     print("Output: ", stc_fname_array)
