...
"""
=============================================
13a. Imports single sub STC files, do single sub contrast, and make group (average and SD across subjects)
==============================================
...
for ei, evnt in enumerate(event_type):
    ...
    #     extension = contrast_kind[ci] +'_' + event_type[ei] + '_hc_' + 'stcGSTD' +'_evkCondiContrast_SRC_' + version +'_' + method +'_' + ampliNormalization +'_' + bsln
    #     stc_fname_array = op.join( config_for_gogait.eeg_dir_GOODremove,
    #                           config_for_gogait.base_fname_avg_npy.format(**locals()))
    #     print("Output: ", stc_fname_array)
